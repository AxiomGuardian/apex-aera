...
import { LayoutDashboard, Users, Plus, Upload, Wand2, CheckCircle2, Fingerprint, Target } from "lucide-react";
import { useSession } from "@/components/layout/SessionProvider";
import { navFor } from "@/lib/roles";

const ICONS = { dashboard: LayoutDashboard, clients: Users, onboard: Plus, leads: Target, content: Upload, brand: Fingerprint, queue: CheckCircle2, aera: Wand2 } as const;
